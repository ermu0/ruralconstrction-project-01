...
public class Order {
    ...
    private String foundation; //地基（多种选择）
    private String structure; //结构（多种选择）
    private String orderContract; //订单合同（存储地址）
    private String orderServer; //派单选择的服务商（多种选择）
    private String customerNotes; //用户备注
    private String adminNotes; //后台管理人员备注
    private LocalDateTime orderTime; //最近一次支付时间
